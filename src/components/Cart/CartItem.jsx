                  ...
                  <div className="CartShop">
                    <Container>
                      <Row>
                        ...
                        <Col lg="9">
                          <div>
                            <p className="CartShopDecs">{item && item.product&&item.product.title}</p>
                            ...
                            <Row>
                              <div>
                                <BiSolidShoppingBags
                                  ...
                                  className="mx-2"
                                />
                                البائع : {item && item.product&&item.product.brand && item.product.brand.name} 
                              </div>
                            </Row>
                            <p className="CartShopPrice">{item && item.product&&item.product.priceAfterDisc} ريال</p>
